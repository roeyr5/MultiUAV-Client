...
import { ChartType, gaugeChartTypes, graphChartTypes, pieChartTypes, SingleChart } from 'src/app/entities/enums/chartType.enum';
import { IGridsterParameter } from 'src/app/entities/models/IChartEntity';
